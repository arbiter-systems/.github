...
- Relevant validation was run, or the reason it was not run is documented.
- Documentation-only changes were manually reviewed for readability and public safety.
