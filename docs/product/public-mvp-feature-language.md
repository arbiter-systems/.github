...
| AI Waste Radar             | Highlights estimated avoided waste or count-based avoided-work evidence from skipped unhealthy providers, suppressed retries, budget decisions, or lower-cost choices. | Cost/waste summary fields, estimated cost avoided metadata, and avoided-work counters.       |
...
- count-based avoided-work counters as invoices, guaranteed savings, or billing-grade financial attribution
...
- Avoided-work counters can describe skipped calls, attempts, retries, or checks where measured, but they are not invoices or guaranteed savings.
