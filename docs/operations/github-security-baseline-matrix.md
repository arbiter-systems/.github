...
| company | documentation/admin | Private planning/admin repository. |
...
| company | documentation/admin | Optional | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Not Applicable | Required | Required | Blocked (owner/admin verification required) | private docs/admin repo; Advanced Security availability may be plan/visibility gated; alert access verification is lower execution risk than application repos |
